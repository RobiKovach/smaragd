    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) {
                ...
                new swiper_core_Swiper(".numbertwo__slider", {
                    modules: [ Navigation, EffectCards ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                    ...
                    loop: true,
                    navigation: {
                        prevEl: ".numbertwo__slider-button-prev",
                        nextEl: ".numbertwo__slider-button-next"
                    },
                    on: {}
                });
                new swiper_core_Swiper(".numbertree__slider", {
                    modules: [ Navigation, EffectCards ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                    ...
                    loop: true,
                    navigation: {
                        prevEl: ".numbertree__slider-button-prev",
                        nextEl: ".numbertree__slider-button-next"
                    },
                    on: {}
                });
                new swiper_core_Swiper(".taunhaus-slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                    ...
                    loop: true,
                    navigation: {
                        prevEl: ".taunhaus-prev",
                        nextEl: ".taunhaus-next"
                    },
                    on: {}
                });
                new swiper_core_Swiper(".duplex-slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                ...
                new swiper_core_Swiper(".individual-slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                    ...
                    loop: true,
                    navigation: {
                        prevEl: ".individual-prev",
                        nextEl: ".individual-next"
                    },
                    on: {}
                });
            }
...
***************************************************************************** */
        ...
        function getUTMParameters() {
            ...
            const utmSource2 = urlParams.get("utm_source__2");
            if (utmSource || utmSource2) {
                ...
                document.getElementById("utm_source__2").value = utmSource2;
                document.getElementById("utm_medium__2").value = urlParams.get("utm_medium__2");
                document.getElementById("utm_campaign__2").value = urlParams.get("utm_campaign__2");
                document.getElementById("utm_content__2").value = urlParams.get("utm_content__2");
                document.getElementById("utm_term__2").value = urlParams.get("utm_term__2");
                console.log(utmSource);
            } else console.log("One or both parameters are missing. Skipping execution.");
        }
        getUTMParameters();
        window["FLS"] = true;
        menuInit();
